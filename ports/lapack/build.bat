...
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i lapack64.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i blas64.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i cblas64.pc
sed -e "s#\([A-Za-z]\):/\([^/]\)#/\L\1\E/\2#g" -i lapacke64.pc
popd
exit /b 0
