...
cmake -G "Ninja"                                                                                   ^
  ...
  -DCMAKE_CXX_FLAGS="%OPTIONS% %DEFINES%"                                                          ^
  ...
  -DLLVM_ENABLE_PROJECTS="bolt;clang;clang-tools-extra;libc;lld;mlir;flang;openmp;polly;pstl"      ^
  ...
  -DCLANG_BOOTSTRAP_PASSTHROUGH="CMAKE_BUILD_TYPE;CMAKE_INSTALL_PREFIX;CMAKE_INSTALL_LIBDIR;CMAKE_INSTALL_UCRT_LIBRARIES;CLANG_DEFAULT_CXX_STDLIB;CLANG_DEFAULT_LINKER;CLANG_DEFAULT_OBJCOPY;CLANG_DEFAULT_OPENMP_RUNTIME;CLANG_DEFAULT_RTLIB;CLANG_ENABLE_ARCMT;CLANG_ENABLE_OBJC_REWRITER;LIBCXX_USE_COMPILER_RT;LLVM_BUILD_LLVM_C_DYLIB;LLVM_BUILD_DOCS;LLVM_BUILD_EXAMPLES;LLVM_BUILD_TESTS;LLVM_BUILD_TOOLS;LLVM_BUILD_UTILS;LLVM_ENABLE_OCAMLDOC;LLVM_ENABLE_RTTI;LLVM_ENABLE_ZSTD;LLVM_ENABLE_PROJECTS;LLVM_ENABLE_RUNTIMES;LLVM_INCLUDE_BENCHMARKS;LLVM_INCLUDE_DOCS;LLVM_INCLUDE_EXAMPLES;LLVM_INCLUDE_TESTS;LLVM_INCLUDE_TOOLS;LLVM_INCLUDE_UTILS;LLVM_INSTALL_UTILS;LLVM_OPTIMIZED_TABLEGEN;LLVM_TARGETS_TO_BUILD;FFI_INCLUDE_DIRS;FFI_LIBRARIES;FFI_STATIC_LIBRARIES;OCAML_STDLIB_PATH;Z3_INCLUDE_DIR;Z3_LIBRARIES;ZLIB_INCLUDE_DIR;ZLIB_LIBRARY;LLVM_ENABLE_ZSTD;zstd_INCLUDE_DIR;zstd_LIBRARY;zstd_STATIC_LIBRARY;LIBXML2_INCLUDE_DIR;LIBXML2_INCLUDE_DIRS;LIBXML2_LIBRARIES;LIBXML2_XMLLINT_EXECUTABLE;LIBXML2_DEFINITIONS;LIBXML2_LIBRARY;PERL_EXECUTABLE;Python3_EXECUTABLE;Python3_LIBRARIES;Python3_INCLUDE_DIRS;Python3_LIBRARY_DIRS;Python3_RUNTIME_LIBRARY_DIRS;Python3_ROOT_DIR_DIR;Python3_FIND_ABI;Python3_FIND_STRATEGY;Python3_FIND_REGISTRY;Python3_FIND_FRAMEWORK;Python3_FIND_UNVERSIONED_NAMES;SWIG_DIR;SWIG_EXECUTABLE"    ^
  -DBOOTSTRAP_CMAKE_C_FLAGS="%BOOTSTRAP_OPTIONS% %DEFINES%"                                        ^
  -DBOOTSTRAP_CMAKE_CXX_FLAGS="%BOOTSTRAP_OPTIONS% %DEFINES%"                                      ^
...
cd "%BUILD_DIR%" && ninja stage2-install
if %errorlevel% neq 0 exit 1
call :clean_build
exit /b 0
