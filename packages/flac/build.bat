...
set C_OPTS=-nologo -MD -diagnostics:column -wd4819 -wd4996 -openmp:llvm -utf-8 -Zc:__cplusplus -experimental:c11atomics
...
for %%f in ("%PREFIX%\lib\pkgconfig\flac*.pc") do (
