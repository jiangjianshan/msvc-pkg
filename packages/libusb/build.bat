...
copy /Y /V %BUILD_DIR%\v143\%ARCH%\Release\dll\*.lib "%PREFIX%\lib"
copy /Y /V %BUILD_DIR%\v143\%ARCH%\Release\dll\*.dll "%PREFIX%\bin"
copy /Y /V %BUILD_DIR%\v143\%ARCH%\Release\*.exe "%PREFIX%\bin"
