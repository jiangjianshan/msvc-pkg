...
cd "%BUILD_DIR%" && nmake CCTYPE=MSVC143 INST_DRV= INST_TOP="%PREFIX%" INST_HTML="%PREFIX%\share\html"
exit /b 0
...
cd "%BUILD_DIR%" && nmake install CCTYPE=MSVC143 INST_DRV= INST_TOP="%PREFIX%" INST_HTML="%PREFIX%\share\html"
...
cd "%BUILD_DIR%" && nmake clean CCTYPE=MSVC143 INST_DRV= INST_TOP="%PREFIX%" INST_HTML="%PREFIX%\share\html"
exit /b 0
