...
meson setup "%BUILD_DIR%"                                                      ^
  ...
  -Dcpp_winlibs="Ole32.lib,User32.lib" || exit 1
exit /b 0
...
sed -E "s#([A-Za-z]):[\\/]#/\L\1/#gI" -i "%PREFIX%/lib/pkgconfig/glibmm-2.68.pc"
sed -E "s#([A-Za-z]):[\\/]#/\L\1/#gI" -i "%PREFIX%/lib/pkgconfig/giomm-2.68.pc"
call :clean_build
exit /b 0
