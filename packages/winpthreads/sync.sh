...
patch_package()
{
  ...
  cd "$SRC_DIR"
  patch -Np1 -i "$PKG_DIR/001-winpthreads-12.0.0-avoid-other-libraries-report-pid_t-error.diff"
...
. $ROOT_DIR/common.sh
download_extract mingw-w64-$PKG_VER$EXT 3 mingw-w64-$PKG_VER/mingw-w64-libraries/winpthreads
