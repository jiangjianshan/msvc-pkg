...
patch_package()
{
  ...
  cd "$SRC_DIR"
  patch -Np1 -i "$PKG_DIR/001-giflib-5.2.2-fix-issue-of-missing-getopt.diff"
  patch -Np1 -i "$PKG_DIR/002-giflib-5.2.2-fix-unresolved-external-symbol-strtok_r.diff"
}
