...
set F_OPTS=-nologo -MD -Qdiag-disable:10448 -fast -fp:strict -Qopenmp -Qopenmp-simd -assume:nounderscore
...
ifort %F_OPTS% -heap-arrays -exe:tpolysolve.exe tpolysolve.f90 !base_objs!
