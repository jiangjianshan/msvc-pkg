...
set DEFINES=-DWIN32 -D_WIN32_WINNT=_WIN32_WINNT_WIN10 -D_CRT_DECLARE_NONSTDC_NAMES -D_CRT_SECURE_NO_DEPRECATE -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_DEPRECATE -D_CRT_NONSTDC_NO_WARNINGS -DCPPCHECKLIB_EXPORT -DTINYXML2_EXPORT -DSIMPLECPP_EXPORT
...
cd "%BUILD_DIR%" && (
  copy /Y /V bin\cppcheck.exe "%PREFIX%\bin"
  copy /Y /V bin\cppcheck-core.dll "%PREFIX%\bin"
  copy /Y /V bin\cppcheck-core.lib "%PREFIX%\lib"
)
