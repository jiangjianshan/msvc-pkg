...
set OPTIONS=-nologo -MD -diagnostics:column -wd4819 -fp:precise -openmp:llvm -experimental:c11atomics
set DEFINES=-DWIN32 -D_WIN32_WINNT=_WIN32_WINNT_WIN10 -D_CRT_DECLARE_NONSTDC_NAMES -D_CRT_SECURE_NO_DEPRECATE -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_DEPRECATE -D_CRT_NONSTDC_NO_WARNINGS -D_USE_MATH_DEFINES
...
meson setup "%BUILD_DIR%"                                                      ^
  ...
  -Dc_std=c17                                                                  ^
  -Dc_args="%OPTIONS% %DEFINES%"                                               ^
  -Dcpp_std=c++17                                                              ^
  -Dcpp_args="-EHsc %OPTIONS% %DEFINES%"                                       ^
