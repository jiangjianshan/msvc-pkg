...
class BashUtils:
    ...
    def find_git_root(cls):
        ...
        try:
            ...
            Logger.exception(f"Unexpected error in find_git_root: [bold red]{str(e)}[/bold red]")
            return None
    ...
    def find_bash(cls):
        ...
        try:
            ...
            Logger.exception(f"Unexpected error in find_bash: [bold red]{str(e)}[/bold red]")
            return None
    ...
    def find_git():
        ...
        try:
            ...
            try:
                ...
                Logger.exception(f"Error decoding error message: [bold red]{str(decode_error)}[/bold red]")
            return None
        except Exception as e:
